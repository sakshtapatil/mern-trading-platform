...
function CreateTicket() {
    return ( 
      ...
      <div className="row p-5 mt-5 mb-5">
        ...
        <h4 className="mb-5">
        <i class="fa-solid fa-circle-plus"></i> Account Opening </h4>
      ...
      <div className="col-4 p-5 mt-5 mb-5">
        <h4 className="mb-5">
        <i class="fa-solid fa-chart-column"></i>Your Zerodha Account </h4>
      ...
      <div className="col-4 p-5 mt-5 mb-5">
        <h4 className="mb-5">
       <i class="fa-solid fa-circle-notch"></i> Console </h4>
      ...
      <div className="col-4 p-5 mt-5 mb-5">
        <h4 className="mb-5">
       <i class="fa-regular fa-credit-card"></i> Funds </h4>
